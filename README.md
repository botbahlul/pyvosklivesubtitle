...
When you run this app for the very first time it may takes some times to download vosk language model, you can check those  downloaded models in "/usr/share/vosk" (if you're on Linux) and "C:\\Users\\Username\\.cache\vosk\\" or "C:\Users\Username\AppData\Local\vosk\\" (if you're on Windows).
